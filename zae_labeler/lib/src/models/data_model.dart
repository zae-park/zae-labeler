...
class UnifiedData {
  ...
  UnifiedData(
      {this.file, this.seriesData, this.objectData, required this.fileType});
}
...
class FileData {
  ...
  FileData({required this.name, required this.type, required this.content});
  ...
  static FileData fromJson(Map<String, dynamic> json) => FileData(
        name: json['name'],
        type: json['type'],
