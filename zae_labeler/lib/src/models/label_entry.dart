...
class MultiClassificationLabel {
  ...
  factory MultiClassificationLabel.fromJson(Map<String, dynamic> json) =>
      MultiClassificationLabel(labeledAt: json['labeled_at'], labels: List<String>.from(json['label']));
}
...
class SegmentationData {
  ...
  factory SegmentationData.fromJson(Map<String, dynamic> json) =>
      SegmentationData(indice: List<String>.from(json['indice']), classes: List<String>.from(json['classes']));
}
