...
class LabelUseCases {
  ...
  LabelUseCases._({required this.repository, required this.single, required this.validation, required this.io});

  factory LabelUseCases.from(LabelRepository repository) => LabelUseCases._(
      repository: repository, single: SingleLabelUseCases(repository), validation: LabelValidationUseCases(repository), io: LabelIOUseCases(repository));
}
