...
final Map<LabelingMode, LabelingViewModel Function(Project, StorageHelperInterface, LabelUseCases, List<UnifiedData>?)> labelingViewModelBuilders = {
...
class LabelingViewModelFactory {
  /// 동기 생성자
  static LabelingViewModel create(Project project, StorageHelperInterface helper, LabelUseCases useCases, {List<UnifiedData>? initialDataList}) {
  ...
  static Future<LabelingViewModel> createAsync(Project project, StorageHelperInterface helper, LabelUseCases useCases) async {
