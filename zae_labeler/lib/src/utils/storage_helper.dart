...
class StorageHelper extends PlatformStorageHelper {
  ...
  Future<String> downloadProjectConfig(Project project) =>
      _instance.downloadProjectConfig(project);
  ...
  Future<void> saveProjects(List<Project> projects) =>
      _instance.saveProjects(projects);
