...
final Map<LabelingMode, LabelingViewModel Function(Project, StorageHelperInterface, AppUseCases, List<DataWithStatus>?)> labelingViewModelBuilders = {
...
class LabelingViewModelFactory {
  /// 동기 생성자
  static LabelingViewModel create(Project project, StorageHelperInterface helper, AppUseCases useCases, {List<DataWithStatus>? initialDWSList}) {
    return labelingViewModelBuilders[project.mode]!(project, helper, useCases, initialDWSList);
  }
