...
import 'package:zae_labeler/src/domain/project/clear_label_use_case.dart';
...
void main() {
  group('ClearLabelUseCase', () {
    ...
    late ClearLabelDataUseCase useCase;

    setUp(() {
      repository = MockProjectRepository();
      useCase = ClearLabelDataUseCase(repository: repository);
    });
